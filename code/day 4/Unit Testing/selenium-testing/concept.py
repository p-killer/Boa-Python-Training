...
Then get the web driver from 
https://docs.seleniumhq.org/projects/webdriver. 

There are all kind of webdrivers including:
    ChromeDriver
    FirefoxDriver
    RemoteWebDriver

After installation of the web driver, we can make Python start 
the browser using:  pip install -U selenium
...
#selenium will start webbrowser automatically
'''
